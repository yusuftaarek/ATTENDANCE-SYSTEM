...
display.lcd_display_string("  Scanning for", 1)
display.lcd_display_string("   cards!....", 2)
sleep(2)
    ...
    while(1):
        ...
        if id:
            ...
            if user:
                display.lcd_clear() 
                sleep(1)
                display.lcd_display_string("USER: "+str(user), 1)
                ...
                display.lcd_clear() 
                sleep(1)
                display.lcd_display_string("THIS CARD IS NOT", 1)
